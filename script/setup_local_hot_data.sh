...
note "Predictions and data/database are intentionally left under the repo path."
note "You can now rerun build/train/inference; runtime logs will go to /docker."
